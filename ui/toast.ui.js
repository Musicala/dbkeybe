// ─────────────────────────────────────────────────────────
// toast.ui.js — Notificaciones tipo toast
// ─────────────────────────────────────────────────────────
 ...
 * @param {number} duration — ms antes de desaparecer (0 = no desaparece)
 */
...
export function showSuccess(msg, duration)  { return showToast(msg, 'success', duration); }
export function showError(msg, duration)    { return showToast(msg, 'error',   duration); }
export function showInfo(msg, duration)     { return showToast(msg, 'info',    duration); }
export function showWarning(msg, duration)  { return showToast(msg, 'warning', duration); }
